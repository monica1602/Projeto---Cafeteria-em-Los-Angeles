...
### Tabela restaurantes
<img src="https://github.com/user-attachments/assets/dff722f6-60ed-49cc-91a7-2cc15880d5f6" alt="Projeto 10" width="1000"/>
...
### Gráfico - Tipos de restaurantes
<img src="https://github.com/user-attachments/assets/f7e0bac7-9ef5-4700-b7ef-2bca8eadb6ae" alt="Projeto 10" width="800"/>

## Resultados
- A análise permitiu identificar as vias com maior concentração de restaurantes na cidade.
- Verificou-se que a maioria dos estabelecimentos localizados na área analisada pertence, de fato, ao segmento de restaurantes.
- Foi possível observar uma correlação entre a quantidade de assentos disponíveis e o tipo de restaurante, sugerindo que determinados perfis de estabelecimentos tendem a oferecer maior capacidade de atendimento ao público.
- Constatou-se que as padarias (bakeries) são predominantemente parte de redes de estabelecimentos, indicando um modelo de negócios mais padronizado e escalável.
